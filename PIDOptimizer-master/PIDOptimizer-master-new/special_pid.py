...
class special_Adapidoptimizer(Optimizer):
    def __init__(self, params, lr=required, beta=0.99, momentum=[0.9, 0.9],
        ...
        super(special_Adapidoptimizer, self).__init__(params, defaults)
        self.get_grad_symbol = False

    def __setstate__(self, state):
        super(special_Adapidoptimizer, self).__setstate__(state)
