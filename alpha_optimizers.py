    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                p.data.add_(-group['lr'], (I_buf / (1 - momentum ** param_state['time_buffer'])) / (v_buf ** (1 / np.min([1.5 + param_state['time_buffer'] / 1000, 5])) + epsilon))
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                p.data.add_(-group['lr'], ((torch.sign(param_state['I_buffer']) * (torch.abs(param_state['I_buffer']) ** (1/alpha))) / (1 - momentum ** param_state['time_buffer'])))
